...
def createExamples():
    numberArrayExamples = open('C:\Python27/numArEx.txt','a')
    ...
    for eachNum in numbersWeHave:
        for eachVer in versionsWeHave:
            ...
            imgFilePath = 'C:\Users\Inspiron\Desktop\images/numbers/'+str(eachNum)+'.'+str(eachVer)+'.png'
